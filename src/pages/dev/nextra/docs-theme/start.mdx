...
<Tabs items={['pnpm', 'npm', 'yarn']}>
  <Tab>
    ```bash copy pnpm i next react react-dom nextra nextra-theme-docs ```
  </Tab>
  <Tab>
    ```bash copy npm i next react react-dom nextra nextra-theme-docs ```
  </Tab>
  <Tab>
    ```bash copy yarn add next react react-dom nextra nextra-theme-docs ```
  </Tab>
</Tabs>
...
import switchIcon from '@components/nextra/icons/switch'

<Cards>
  <Card
    icon={switchIcon}
    title="Configure Nextra"
