...
<div className="home-content">
  <div className="content-container">
    <div className="header" style={{}}>
      <img className="headimg" src={process.env.basePath + "/pineline.svg"}/>
      <h1 className="headline">Pineline</h1>
    </div>
    <p className="subtitle">Powerful and reproducible theory predictions, by <a className="nextjs-link" href="https://nextjs.org" target="_blank">N3PDF</a>.</p>
    <p className={"subtitle " + styles.links}>
  ...
  <style jsx>{`
    ...
    :global(#docs-card) {
      background-image: url(${process.env.basePath}/nextra/assets/card-1.png);
    ...
    :global(.dark #docs-card) {
      background-image: url(${process.env.basePath}/nextra/assets/card-1.dark.png);
    }
    :global(#highlighting-card) {
      min-height: 300px;
      background-image: linear-gradient(to top, transparent, #fff 50%), url(${process.env.basePath}/nextra/assets/syntax-highlighting.svg);
      background-size: 634px;
      background-position: -6px calc(100% + 4px);
      background-repeat: no-repeat;
    }
    :global(.dark #highlighting-card) {
      background-image: linear-gradient(to top, transparent, #202020 50%), url(${process.env.basePath}/nextra/assets/syntax-highlighting.svg);
    }
    ...
    <div className="content-container">
      <Features>
        ...
        <Feature centered style={{
          ...
          backgroundImage: 'url(' + process.env.basePath + '/nextra/assets/gradient-bg.jpeg)',
        ...
        <Feature large lightOnly style={{
          ...
          <video autoPlay="autoplay" loop muted playsInline style={{
            ...
            <source src={process.env.basePath + "/nextra/assets/search.mp4"} type="video/mp4"/>
          </video>
        </Feature>
        <Feature large style={{
          color: 'white',
          backgroundImage: 'url(' + process.env.basePath + '/nextra/assets/routing.png), url(' + process.env.basePath + '/nextra/assets/gradient-bg.jpeg)',
  ...
  <div className="content-container" style={{ marginTop: '4rem', marginBottom: '4rem' }}>
    <p className="subtitle"><Link href="/introduction"><a>Get Started →</a></Link></p>
  </div>
</div>
